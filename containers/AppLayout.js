							...
							return (
								<div className="notif-content" key={i}>
									<div>
										...
										<span name="chat-content">
											{c.chat.recentContent.content}
										</span>
									</div>
								</div>
							);
	...
	return (
		<div id="wrapper">
			<div id="page-container">
				<header id="nav-header">
					<div className="menu-navigation">
						...
						>
							...
							<div
								className="menu-box"
								style={{ maxHeight: `${togglePJ ? 140 : 0}px` }}
							>
								<Link href="/project">
									<a className="menu-btn child">찾아보기</a>
								</Link>
								<Link href="/project/write">
									<a className="menu-btn child">모집하기</a>
								</Link>
							</div>
						</div>
						<div
						...
						>
							...
							<div
								className="menu-box"
								style={{ maxHeight: `${toggleJW ? 140 : 0}px` }}
							>
								<Link href="/jewel">
									<a className="menu-btn child">찾아보기</a>
								</Link>
				...
				{<NotifBox />}
				{user && openSubProfile && (
					<Curtain component={<NoSubProfile />} />
				)}
			</div>
		</div>
	);
